<template>
  <div class="about text-center bg-black text-white">
    ...
    <h3 class="para w-75 mx-auto">Welcome to Gentleman`s Edge Barber , your go-to destination for exceptional haircuts in the heart of Khayelitsha! Established in 2020, we take pride in bringing contemporary and expert grooming services to our vibrant community. At  Gentleman`s Edge Babrber, we are more than just a barbershop; we are a hub for style, community, and top-notch hair care. Our skilled barbers are dedicated to delivering precision haircuts that suit your unique style and personality.</h3>
