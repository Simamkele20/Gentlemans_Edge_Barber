...
export default {
  ...
  methods: {
    ...
    editBooking(bookID) {
      const updatedValue = {};
      if (this.payload.bookDay) {
        updatedValue.bookDay = this.payload.bookDay;
      }
      if (this.payload.bookTime) {
        updatedValue.bookTime = this.payload.bookTime;
      }
      ...
      if (Object.keys(updatedValue).length > 0) {
        const updateData = Object.assign({}, { bookID }, updatedValue);
